...
use markdown_commonmark_contracts::{Paragraph, Text};
...
fn deep_json(depth: usize) -> String {
    ...
    for _ in 1..depth {
        json.push_str(r#"{"kind":"markdown_commonmark_contracts::nodes::Paragraph","span":{"start":0,"end":0},"data":{},"children":["#);
    }
    json.push_str(r#"{"kind":"markdown_commonmark_contracts::nodes::Paragraph","span":{"start":0,"end":0},"data":{}}"#);
    for _ in 1..depth {
        json.push_str("]}");
    }
    json.push_str("]}");
